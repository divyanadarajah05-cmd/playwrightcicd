...
test('TestCase16 - REST API - GET Request', async ({ request }) => {
...
test('TestCase16 - REST API - POST Request', async ({ request }) => {
...
test('TestCase16 - REST API - PUT Request', async ({ request }) => {
...
test('TestCase16 - REST API - DELETE Request', async ({ request }) => {
  await request.delete('https://jsonplaceholder.typicode.com/posts/1').then(async (response) => {
    expect(response.status()).toBe(200);
  })
})

test('TestCase16 - IPAPI.co - GET Request', async ({ request }) => {
